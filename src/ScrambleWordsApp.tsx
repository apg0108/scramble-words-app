...
import { ActionButton, Guess, Header, Stats } from './components/core';
import { ScrambleWord } from './components/core/ScrambleWord';
import { getInitialState } from './utils/utilsFunction';
import { Winner } from './components/core/Winner';
                ...
                <Card className="backdrop-blur-sm bg-white/80 border-0 shadow-xl">
                    <CardContent className="p-8">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <ActionButton state={state} dispatch={dispatch} actionButton='SKIP'/>
                            <ActionButton state={state} dispatch={dispatch} actionButton='PLAY_AGAIN'/>
                        </div>
                    </CardContent>
                </Card>
            </div>
